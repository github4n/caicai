...
namespace Smart.Core.Throttle
{
    ...
    public class ApiThrottleOptions
    {
        ...
        public Func<HttpContext, ThrottleValve, IntercepteWhere, IActionResult> onIntercepted = (context, valve, where) => { return new Microsoft.AspNetCore.Mvc.ObjectResult(Results.Result.Fail(99, "访问过于频繁，请稍后重试！")); };
    ...
    public class GlobalOptions
    {
        ...
        /// 全局阀门
        /// </summary>
        internal IList<ThrottleValve> Valves { set; get; } = new List<ThrottleValve>();

...
{
    public class BJKL8_opencai
    {
        public static List<string> Analysis()
        {
            List<string> list = new List<string>();
            var client = NetHelper.GetHttpClient("BJKL8_opencai");
            {
                var result = client.GetAsync("http://t.apiplus.net/newly.do?code=bjkl8&format=json").Result;

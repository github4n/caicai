...
{
    public class TGSSC_opencai
    {
        public static List<string> Analysis()
        {
            List<string> list = new List<string>();
            var client = NetHelper.GetHttpClient("TGSSC_opencai");
            {
                var result = client.GetAsync("http://t.apiplus.net/newly.do?code=tjssc&format=json").Result;

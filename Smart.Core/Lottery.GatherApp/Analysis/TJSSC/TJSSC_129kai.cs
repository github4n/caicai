...
{
   public class TJSSC_129kai
    {
        public static List<string> Analysis()
        {
            List<string> list = new List<string>();
            var client = NetHelper.GetHttpClient("TJSSC_129kai");
            {
                var result = client.GetAsync("http://129kai.net/index.php?c=api&a=updateinfo&cp=tjssc&uptime=1488040736&chtime=36005&catid=126&modelid=1").Result;

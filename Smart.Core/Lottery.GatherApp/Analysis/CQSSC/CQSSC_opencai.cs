...
{
    public class CQSSC_opencai
    {
        public static List<string> Analysis()
        {
            List<string> list = new List<string>();
            var client = NetHelper.GetHttpClient("CQSSC_opencai");
            {
                var result = client.GetAsync("http://t.apiplus.net/newly.do?code=cqssc&format=json").Result;

...
{
    public class CQSSC_168
    {
        public static List<string> Analysis()
        {
            List<string> list = new List<string>();
            var client = NetHelper.GetHttpClient("CQSSC_168");
            {
                var result = client.GetAsync("http://api.api68.com/CQShiCai/getBaseCQShiCaiList.do?lotCode=10002").Result;

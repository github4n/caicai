...
{
    public class JSK3_168
    {
        public static List<string> Analysis()
        {
            List<string> list = new List<string>();
            var client = NetHelper.GetHttpClient("JSK3_168");
            {
                var result = client.GetAsync("http://api.api68.com/lotteryJSFastThree/getJSFastThreeList.do?date=&lotCode=10007").Result;

...
{
    public class BJPK10_opencai
    {
        public static List<string> Analysis()
        {
            List<string> list = new List<string>();
            var client = NetHelper.GetHttpClient("BJPK10_opencai");
            {
                var result = client.GetAsync("http://t.apiplus.net/newly.do?code=bjpk10&format=json").Result;

...
{
    public class GD11X5_168
    {
        public static List<string> Analysis()
        {
            List<string> list = new List<string>();
            var client = NetHelper.GetHttpClient("GD11X5_168");
            {
                var result = client.GetAsync("http://api.api68.com/ElevenFive/getElevenFiveList.do?date=&lotCode=10006").Result;

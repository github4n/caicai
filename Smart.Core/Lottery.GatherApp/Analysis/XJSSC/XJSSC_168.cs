...
{
    public class XJSSC_168
    {
        public static List<string> Analysis()
        {
            List<string> list = new List<string>();
            var client = NetHelper.GetHttpClient("XJSSC_168");
            {
                var result = client.GetAsync("http://api.api68.com/CQShiCai/getBaseCQShiCaiList.do?lotCode=10004").Result;

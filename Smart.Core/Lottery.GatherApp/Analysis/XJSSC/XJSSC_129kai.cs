...
{
   public class XJSSC_129kai
    {
        public static List<string> Analysis()
        {
            List<string> list = new List<string>();
            var client = NetHelper.GetHttpClient("XJSSC_129kai");
            {
                var result = client.GetAsync("http://129kai.net/index.php?c=api&a=updateinfo&cp=xjssc&uptime=1488040736&chtime=36005&catid=126&modelid=1").Result;

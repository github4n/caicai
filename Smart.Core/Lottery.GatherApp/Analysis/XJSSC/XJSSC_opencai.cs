...
{
   public class XJSSC_opencai
    {
        public static List<string> Analysis()
        {
            List<string> list = new List<string>();
            var client = NetHelper.GetHttpClient("XJSSC_opencai");
            {
                var result = client.GetAsync("http://t.apiplus.net/newly.do?code=xjssc&format=json").Result;

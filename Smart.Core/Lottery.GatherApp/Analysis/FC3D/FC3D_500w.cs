...
{
    public class FC3D_500w
    {
        public static List<string> Analysis()
        {
            List<string> list = new List<string>();
            var client = NetHelper.GetHttpClient("FC3D_500w");
            {
                ...
                var result = client.GetAsync("http://www.500.com/static/info/kaijiang/xml/sd/list10.xml").Result;
